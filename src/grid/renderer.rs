...
pub(crate) fn expand_spacer<'a>(spacer: &'a GridSpacer, pos: VUnit, len: VUnit, repeat_count: usize) -> impl Iterator<Item = SpacerSolved> + 'a {
...
impl GridRenderer {
    ...
    pub fn add_frame(&mut self, grid_handle: GridHandle, frame_handle: FrameHandle, x: XName, y: YName) {
